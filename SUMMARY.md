...
- [ioc 介绍](./ch1-ioc/README.md)
    ...
    - [BeanPostProcessor 介绍](./ch1-ioc/BeanPostProcessor介绍.md)
...
- [aop 介绍](./ch2-aop/README.md)  
  ...
  - [spring 基于注解事务](./ch2-aop/spring基于注解事务.md)


- [event 介绍](./ch3-event/README.md)  
  - [spring event 示例](./ch3-event/spring event 示例.md)


- [基于示例剖析 spring 源码](./ch4-examples/README.md)
  - 基于 xml 和基于注解 bean 加载区别

- [spring 相关疑难问题总结](./ch4-other/README.md)
  - [spring 基于注解事务莫名其妙失效问题排查记录](./ch4-other/spring 基于注解事务莫名其妙失效问题排查记录.md)
